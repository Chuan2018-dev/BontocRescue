...
<head>
    ...
    <style>
        ...
        .civilian-hero-callout,.civilian-helper-card,.civilian-action-card,.civilian-history-card,.form-step-card,.requirement-item{padding:18px;border-radius:24px;border:1px solid rgba(15,31,47,.08);background:linear-gradient(135deg,rgba(255,255,255,.98),rgba(246,250,255,.96));display:grid;gap:12px}
        .civilian-hero-callout{background:linear-gradient(135deg,rgba(15,31,47,.97),rgba(31,76,113,.94));color:#fff;border-color:rgba(255,255,255,.08)}
        .civilian-hero-callout p,.civilian-hero-callout li{color:rgba(255,255,255,.82)}
        ...
        .capture-action-card{position:relative;cursor:pointer;text-align:left;background:linear-gradient(135deg,#dc2f34,#a31419);border:1px solid rgba(201,28,33,.32);box-shadow:0 18px 34px rgba(201,28,33,.16);color:#fff;transition:transform .2s ease,box-shadow .2s ease,border-color .2s ease}
        .capture-action-card:hover,.capture-action-card:focus-visible{transform:translateY(-2px);border-color:rgba(201,28,33,.46);box-shadow:0 24px 40px rgba(201,28,33,.24)}
