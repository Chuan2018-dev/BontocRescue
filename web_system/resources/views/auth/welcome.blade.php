@php
    $html = file_get_contents(resource_path('reference_html/01_onboarding/welcome_screen/code.html'));
    ...
    $cta = '<div class="flex flex-wrap gap-4 pt-4">'
        ...
        . '<button type="button" data-open-pwa-helper class="bg-white/75 text-primary px-6 py-4 rounded-md font-bold border border-outline-variant/20 hover:bg-white transition-all inline-flex items-center justify-center">Download App</button>'
        . '</div>'
        . '</div>';
